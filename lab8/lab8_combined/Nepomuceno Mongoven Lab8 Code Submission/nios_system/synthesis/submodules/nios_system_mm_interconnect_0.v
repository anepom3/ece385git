...
module nios_system_mm_interconnect_0 (
		...
		output wire [0:0]  nios2_qsys_0_control_slave_address,             //               nios2_qsys_0_control_slave.address
		input  wire [31:0] nios2_qsys_0_control_slave_readdata,            //                                         .readdata
	...
	wire   [31:0] nios2_qsys_0_control_slave_agent_m0_readdata;                                       // nios2_qsys_0_control_slave_translator:uav_readdata -> nios2_qsys_0_control_slave_agent:m0_readdata
	wire          nios2_qsys_0_control_slave_agent_m0_waitrequest;                                    // nios2_qsys_0_control_slave_translator:uav_waitrequest -> nios2_qsys_0_control_slave_agent:m0_waitrequest
	wire          nios2_qsys_0_control_slave_agent_m0_debugaccess;                                    // nios2_qsys_0_control_slave_agent:m0_debugaccess -> nios2_qsys_0_control_slave_translator:uav_debugaccess
	wire   [27:0] nios2_qsys_0_control_slave_agent_m0_address;                                        // nios2_qsys_0_control_slave_agent:m0_address -> nios2_qsys_0_control_slave_translator:uav_address
	wire    [3:0] nios2_qsys_0_control_slave_agent_m0_byteenable;                                     // nios2_qsys_0_control_slave_agent:m0_byteenable -> nios2_qsys_0_control_slave_translator:uav_byteenable
	wire          nios2_qsys_0_control_slave_agent_m0_read;                                           // nios2_qsys_0_control_slave_agent:m0_read -> nios2_qsys_0_control_slave_translator:uav_read
	wire          nios2_qsys_0_control_slave_agent_m0_readdatavalid;                                  // nios2_qsys_0_control_slave_translator:uav_readdatavalid -> nios2_qsys_0_control_slave_agent:m0_readdatavalid
	wire          nios2_qsys_0_control_slave_agent_m0_lock;                                           // nios2_qsys_0_control_slave_agent:m0_lock -> nios2_qsys_0_control_slave_translator:uav_lock
	wire   [31:0] nios2_qsys_0_control_slave_agent_m0_writedata;                                      // nios2_qsys_0_control_slave_agent:m0_writedata -> nios2_qsys_0_control_slave_translator:uav_writedata
	wire          nios2_qsys_0_control_slave_agent_m0_write;                                          // nios2_qsys_0_control_slave_agent:m0_write -> nios2_qsys_0_control_slave_translator:uav_write
	wire    [2:0] nios2_qsys_0_control_slave_agent_m0_burstcount;                                     // nios2_qsys_0_control_slave_agent:m0_burstcount -> nios2_qsys_0_control_slave_translator:uav_burstcount
	wire          nios2_qsys_0_control_slave_agent_rf_source_valid;                                   // nios2_qsys_0_control_slave_agent:rf_source_valid -> nios2_qsys_0_control_slave_agent_rsp_fifo:in_valid
	wire  [106:0] nios2_qsys_0_control_slave_agent_rf_source_data;                                    // nios2_qsys_0_control_slave_agent:rf_source_data -> nios2_qsys_0_control_slave_agent_rsp_fifo:in_data
	wire          nios2_qsys_0_control_slave_agent_rf_source_ready;                                   // nios2_qsys_0_control_slave_agent_rsp_fifo:in_ready -> nios2_qsys_0_control_slave_agent:rf_source_ready
	wire          nios2_qsys_0_control_slave_agent_rf_source_startofpacket;                           // nios2_qsys_0_control_slave_agent:rf_source_startofpacket -> nios2_qsys_0_control_slave_agent_rsp_fifo:in_startofpacket
	wire          nios2_qsys_0_control_slave_agent_rf_source_endofpacket;                             // nios2_qsys_0_control_slave_agent:rf_source_endofpacket -> nios2_qsys_0_control_slave_agent_rsp_fifo:in_endofpacket
	wire          nios2_qsys_0_control_slave_agent_rsp_fifo_out_valid;                                // nios2_qsys_0_control_slave_agent_rsp_fifo:out_valid -> nios2_qsys_0_control_slave_agent:rf_sink_valid
	wire  [106:0] nios2_qsys_0_control_slave_agent_rsp_fifo_out_data;                                 // nios2_qsys_0_control_slave_agent_rsp_fifo:out_data -> nios2_qsys_0_control_slave_agent:rf_sink_data
	wire          nios2_qsys_0_control_slave_agent_rsp_fifo_out_ready;                                // nios2_qsys_0_control_slave_agent:rf_sink_ready -> nios2_qsys_0_control_slave_agent_rsp_fifo:out_ready
	wire          nios2_qsys_0_control_slave_agent_rsp_fifo_out_startofpacket;                        // nios2_qsys_0_control_slave_agent_rsp_fifo:out_startofpacket -> nios2_qsys_0_control_slave_agent:rf_sink_startofpacket
	wire          nios2_qsys_0_control_slave_agent_rsp_fifo_out_endofpacket;                          // nios2_qsys_0_control_slave_agent_rsp_fifo:out_endofpacket -> nios2_qsys_0_control_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> nios2_qsys_0_control_slave_agent:cp_valid
	wire  [105:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_qsys_0_control_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // nios2_qsys_0_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [12:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> nios2_qsys_0_control_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> nios2_qsys_0_control_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> nios2_qsys_0_control_slave_agent:cp_endofpacket
	...
	wire          nios2_qsys_0_control_slave_agent_rp_valid;                                          // nios2_qsys_0_control_slave_agent:rp_valid -> router_003:sink_valid
	wire  [105:0] nios2_qsys_0_control_slave_agent_rp_data;                                           // nios2_qsys_0_control_slave_agent:rp_data -> router_003:sink_data
	wire          nios2_qsys_0_control_slave_agent_rp_ready;                                          // router_003:sink_ready -> nios2_qsys_0_control_slave_agent:rp_ready
	wire          nios2_qsys_0_control_slave_agent_rp_startofpacket;                                  // nios2_qsys_0_control_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          nios2_qsys_0_control_slave_agent_rp_endofpacket;                                    // nios2_qsys_0_control_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          nios2_qsys_0_control_slave_agent_rdata_fifo_src_valid;                              // nios2_qsys_0_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] nios2_qsys_0_control_slave_agent_rdata_fifo_src_data;                               // nios2_qsys_0_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          nios2_qsys_0_control_slave_agent_rdata_fifo_src_ready;                              // avalon_st_adapter_001:in_0_ready -> nios2_qsys_0_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> nios2_qsys_0_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> nios2_qsys_0_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // nios2_qsys_0_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> nios2_qsys_0_control_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) nios2_qsys_0_control_slave_translator (
		.clk                    (clk_0_clk_clk),                                     //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset),    //                    reset.reset
		.uav_address            (nios2_qsys_0_control_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (nios2_qsys_0_control_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (nios2_qsys_0_control_slave_agent_m0_read),          //                         .read
		.uav_write              (nios2_qsys_0_control_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (nios2_qsys_0_control_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (nios2_qsys_0_control_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (nios2_qsys_0_control_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (nios2_qsys_0_control_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (nios2_qsys_0_control_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (nios2_qsys_0_control_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (nios2_qsys_0_control_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (nios2_qsys_0_control_slave_address),                //      avalon_anti_slave_0.address
		.av_readdata            (nios2_qsys_0_control_slave_readdata),               //                         .readdata
		.av_write               (),                                                  //              (terminated)
		.av_read                (),                                                  //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) nios2_qsys_0_control_slave_agent (
		.clk                     (clk_0_clk_clk),                                               //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),              //       clk_reset.reset
		.m0_address              (nios2_qsys_0_control_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (nios2_qsys_0_control_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (nios2_qsys_0_control_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (nios2_qsys_0_control_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (nios2_qsys_0_control_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (nios2_qsys_0_control_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (nios2_qsys_0_control_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (nios2_qsys_0_control_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (nios2_qsys_0_control_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (nios2_qsys_0_control_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (nios2_qsys_0_control_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (nios2_qsys_0_control_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (nios2_qsys_0_control_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (nios2_qsys_0_control_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (nios2_qsys_0_control_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (nios2_qsys_0_control_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (nios2_qsys_0_control_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (nios2_qsys_0_control_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (nios2_qsys_0_control_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (nios2_qsys_0_control_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (nios2_qsys_0_control_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (nios2_qsys_0_control_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (nios2_qsys_0_control_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (nios2_qsys_0_control_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (nios2_qsys_0_control_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (nios2_qsys_0_control_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (nios2_qsys_0_control_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (nios2_qsys_0_control_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (nios2_qsys_0_control_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) nios2_qsys_0_control_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                               //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),              // clk_reset.reset
		.in_data           (nios2_qsys_0_control_slave_agent_rf_source_data),             //        in.data
		.in_valid          (nios2_qsys_0_control_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (nios2_qsys_0_control_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (nios2_qsys_0_control_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (nios2_qsys_0_control_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (nios2_qsys_0_control_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (nios2_qsys_0_control_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (nios2_qsys_0_control_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (nios2_qsys_0_control_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (nios2_qsys_0_control_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                       // (terminated)
		.csr_read          (1'b0),                                                        // (terminated)
		.csr_write         (1'b0),                                                        // (terminated)
		.csr_readdata      (),                                                            // (terminated)
	...
	nios_system_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (nios2_qsys_0_control_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (nios2_qsys_0_control_slave_agent_rp_valid),         //          .valid
		.sink_data          (nios2_qsys_0_control_slave_agent_rp_data),          //          .data
		.sink_startofpacket (nios2_qsys_0_control_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (nios2_qsys_0_control_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (nios2_qsys_0_control_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (nios2_qsys_0_control_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (nios2_qsys_0_control_slave_agent_rdata_fifo_src_ready), //         .ready
