...
module lab9_soc_mm_interconnect_0 (
		...
		output wire [1:0]  ONCHIP_MEMORY_s1_address,                   //                  ONCHIP_MEMORY_s1.address
	...
	wire  [103:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> JTAG_UART_avalon_jtag_slave_agent:cp_data
	...
	wire  [104:0] nios2_sysid_control_slave_agent_rf_source_data;                              // NIOS2_SYSID_control_slave_agent:rf_source_data -> NIOS2_SYSID_control_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] nios2_sysid_control_slave_agent_rsp_fifo_out_data;                           // NIOS2_SYSID_control_slave_agent_rsp_fifo:out_data -> NIOS2_SYSID_control_slave_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> NIOS2_SYSID_control_slave_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> NIOS2_SYSID_control_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                       // NIOS2_SYSID_control_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> NIOS2_SYSID_control_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> NIOS2_SYSID_control_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> NIOS2_SYSID_control_slave_agent:cp_endofpacket
	...
	wire    [6:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> NIOS2_debug_mem_slave_agent:cp_channel
	...
	wire  [103:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                   // JTAG_UART_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	...
	wire          nios2_sysid_control_slave_agent_rp_valid;                                    // NIOS2_SYSID_control_slave_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] nios2_sysid_control_slave_agent_rp_data;                                     // NIOS2_SYSID_control_slave_agent:rp_data -> router_004:sink_data
	wire          nios2_sysid_control_slave_agent_rp_ready;                                    // router_004:sink_ready -> NIOS2_SYSID_control_slave_agent:rp_ready
	wire          nios2_sysid_control_slave_agent_rp_startofpacket;                            // NIOS2_SYSID_control_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          nios2_sysid_control_slave_agent_rp_endofpacket;                              // NIOS2_SYSID_control_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          nios2_sysid_control_slave_agent_rdata_fifo_src_valid;                        // NIOS2_SYSID_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] nios2_sysid_control_slave_agent_rdata_fifo_src_data;                         // NIOS2_SYSID_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          nios2_sysid_control_slave_agent_rdata_fifo_src_ready;                        // avalon_st_adapter_002:in_0_ready -> NIOS2_SYSID_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> NIOS2_SYSID_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> NIOS2_SYSID_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                           // NIOS2_SYSID_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> NIOS2_SYSID_control_slave_agent:rdata_fifo_sink_error
